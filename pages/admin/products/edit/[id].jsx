                    ...
                    <form className="flex flex-col gap-4 mt-4" onSubmit={handleEditData}>
                        <div>
                            ...
                            <Select id="katalog" name="katalog" required>
                                ...
                                <option key={item.id} value={item.nama} selected={item.nama === product.katalog} className="text-black">
                                    {item.nama}
                                </option>
                                ))}
                            </Select>
                        ...
                        <div>
                            ...
                            <TextInput id="product" type="text" required name="product" value={product.product}/>
                        </div>
                        <div>
                            <div className="mb-2 block">
                                <Label htmlFor="price">Harga Satuan</Label>
                            </div>
                            <TextInput id="price" type="number" required name="price" value={product.price}/>
                        </div>
                        <div>
                            <div className="mb-2 block">
                                <Label htmlFor="stock">Jumlah Stok</Label>
                            </div>
                            <TextInput id="stock" type="number" required name="stock" value={product.stock}/>
                        </div>
